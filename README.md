...
That installs all ten skills at once. `/plugin marketplace update` pulls in newer versions later, and `/plugin` opens the manager UI to enable, disable, or uninstall.
